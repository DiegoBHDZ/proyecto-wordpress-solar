    ...
    <div class="container-fluid bg-gallery" id="project" style="padding: 120px 0; margin: 90px 0;">
        ...
        <div class="owl-carousel gallery-carousel">
            <div class="gallery-item">
                ...
                <a class="btn btn-primary" href="<?php echo get_template_directory_uri(); ?>/img/gallery-1.jpg" data-lightbox="gallery">
                    <i class="fa fa-2x fa-plus text-white"></i>
                </a>
            </div>
            <div class="gallery-item">
                <img class="img-fluid w-100" src="<?php echo get_template_directory_uri(); ?>/img/gallery-2.jpg" alt="">
                <a class="btn btn-primary" href="<?php echo get_template_directory_uri(); ?>/img/gallery-2.jpg" data-lightbox="gallery">
                    <i class="fa fa-2x fa-plus text-white"></i>
                </a>
            </div>
            <div class="gallery-item">
                <img class="img-fluid w-100" src="<?php echo get_template_directory_uri(); ?>/img/gallery-3.jpg" alt="">
                <a class="btn btn-primary" href="<?php echo get_template_directory_uri(); ?>/img/gallery-3.jpg" data-lightbox="gallery">
                    <i class="fa fa-2x fa-plus text-white"></i>
                </a>
            </div>
            <div class="gallery-item">
                <img class="img-fluid w-100" src="<?php echo get_template_directory_uri(); ?>/img/gallery-4.jpg" alt="">
                <a class="btn btn-primary" href="<?php echo get_template_directory_uri(); ?>/img/gallery-4.jpg" data-lightbox="gallery">
                    <i class="fa fa-2x fa-plus text-white"></i>
                </a>
            </div>
            <div class="gallery-item">
                <img class="img-fluid w-100" src="<?php echo get_template_directory_uri(); ?>/img/gallery-5.jpg" alt="">
                <a class="btn btn-primary" href="<?php echo get_template_directory_uri(); ?>/img/gallery-5.jpg" data-lightbox="gallery">
                    <i class="fa fa-2x fa-plus text-white"></i>
                </a>
            </div>
            <div class="gallery-item">
                <img class="img-fluid w-100" src="<?php echo get_template_directory_uri(); ?>/img/gallery-6.jpg" alt="">
                <a class="btn btn-primary" href="<?php echo get_template_directory_uri(); ?>/img/gallery-6.jpg" data-lightbox="gallery">
                    <i class="fa fa-2x fa-plus text-white"></i>
                </a>
            </div>
        </div>
                ...
                <div class="col-lg-8">
                    <div class="owl-carousel testimonial-carousel">
                        <div class="text-center">
                            <img class="img-fluid mx-auto mb-3" src="<?php echo get_template_directory_uri(); ?>/img/testimonial-1.jpg" style="width: 100px;">
                        ...
                        <div class="text-center">
                            <img class="img-fluid mx-auto mb-3" src="<?php echo get_template_directory_uri(); ?>/img/testimonial-2.jpg" style="width: 100px;">
                            <p style="font-size: 22px;">Dolor eirmod diam stet kasd sed. Aliqu rebum est eos. Rebum elitr dolore et eos labore, stet justo sed est sed. Diam sed sed dolor stet amet eirmod eos labore diam</p>
                            <h4>Client Name</h4>
                            <span>Profession</span>
                        </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img class="img-fluid mb-4" src="<?php echo get_template_directory_uri(); ?>/img/carousel-1.jpg" alt="">
