...
<body <?php body_class(); ?> data-spy="scroll" data-target=".navbar" data-offset="51">
    ...
    <nav class="navbar fixed-top shadow-sm navbar-expand-lg bg-dark navbar-dark py-1 py-lg-0 px-lg-5">
        <a href="<?php echo esc_url(home_url('/')); ?>" class="navbar-brand d-block d-lg-none">
            <h1 class="display-4 text-white text-uppercase m-0"><?php bloginfo('name'); ?></h1>
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
            ...
            <a href="<?php echo esc_url(home_url('/')); ?>" class="navbar-brand bg-primary px-4 mx-3 d-none d-lg-block">
                <h1 class="display-4 text-white text-uppercase m-0"><?php bloginfo('name'); ?></h1>
            </a>
