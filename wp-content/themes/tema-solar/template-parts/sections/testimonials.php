            ...
            <div class="col-lg-8">
                <div class="owl-carousel testimonial-carousel">
                    <div class="text-center">
                        <img class="img-fluid mx-auto mb-3" src="<?php echo get_template_directory_uri(); ?>/assets/images/testimonial-1.jpg" style="width: 100px;" alt="Client 1">
                    ...
                    <div class="text-center">
                        <img class="img-fluid mx-auto mb-3" src="<?php echo get_template_directory_uri(); ?>/assets/images/testimonial-2.jpg" style="width: 100px;" alt="Client 2">
                        <p style="font-size: 22px;">Dolor eirmod diam stet kasd sed. Aliqu rebum est eos. Rebum elitr dolore et eos labore, stet justo sed est sed. Diam sed sed dolor stet amet eirmod eos labore diam</p>
                        <h4>Client Name</h4>
                        <span>Profession</span>
                    </div>
